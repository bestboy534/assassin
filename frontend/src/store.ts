...
type State = { items: SubscriptionItem[]; setItems: (items: SubscriptionItem[]) => void; appendItems: (items: SubscriptionItem[]) => void; updateStatus: (id: string, status: SubscriptionStatus) => void; clearAll: () => void; };
